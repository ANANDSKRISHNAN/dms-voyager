                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            &nbsp;
                                            	<a title="View" class="btn btn-sm btn-warning pull-right mail-modal" data-toggle="modal" data-target="#myModal" data-email = "{{ $data->email }}" >
                                                    <i class="voyager-mail"></i> <span class="hidden-xs hidden-sm">Mail</span>
                                                </a>
                                            &nbsp;
                                        </td>
                                    </tr>
...
@stop
@include('vendor.voyager.users.modal_mail')
@section('css')
